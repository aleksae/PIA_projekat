...
class Sessions {
  ...
  request(body) {
    ...
    return _asyncToGenerator(function* () {
      try {
        const response = yield (0, _http.post)(_nodeFetch.default, `${_this.config.host}/sessions`, _this.config, _this.config.sk, body);
  ...
  get(id, channel) {
    ...
    return _asyncToGenerator(function* () {
      try {
        ...
        const response = yield (0, _http.get)(_nodeFetch.default, `${_this2.config.host}/sessions/${id}`, _this2.config, _this2.config.sk);
        return yield response.json;
      } catch (err) {
        const error = yield (0, _errors.determineError)(err);
        throw error;
  ...
  update(id, body) {
    ...
    return _asyncToGenerator(function* () {
      try {
        const response = yield (0, _http.put)(_nodeFetch.default, `${_this3.config.host}/sessions/${id}/collect-data`, _this3.config, _this3.config.sk, body);
        return yield response.json;
      } catch (err) {
        const error = yield (0, _errors.determineError)(err);
        throw error;
  ...
  complete(id) {
    ...
    return _asyncToGenerator(function* () {
      try {
        const response = yield (0, _http.post)(_nodeFetch.default, `${_this4.config.host}/sessions/${id}/complete`, _this4.config, _this4.config.sk);
        return yield response.json;
      } catch (err) {
        const error = yield (0, _errors.determineError)(err);
        throw error;
  ...
  update3DSMethodCompletionIndicator(id, threeDsMethodCompletion) {
    ...
    return _asyncToGenerator(function* () {
      try {
        ...
        const response = yield (0, _http.put)(_nodeFetch.default, `${_this5.config.host}/sessions/${id}/issuer-fingerprint`, _this5.config, _this5.config.sk, body);
        return yield response.json;
      } catch (err) {
        const error = yield (0, _errors.determineError)(err);
        throw error;
