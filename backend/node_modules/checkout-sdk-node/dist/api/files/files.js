...
class Files {
  ...
  upload(body) {
    ...
    return _asyncToGenerator(function* () {
      try {
        ...
        const response = yield (0, _http.post)(_nodeFetch.default, `${_this.config.host}/files`, _objectSpread(_objectSpread({}, _this.config), {}, {
          formData: true
  ...
  getFile(fileId) {
    ...
    return _asyncToGenerator(function* () {
      try {
        const response = yield (0, _http.get)(_nodeFetch.default, `${_this2.config.host}/files/${fileId}`, _this2.config, _this2.config.sk);
        return yield response.json;
      } catch (err) {
        const error = yield (0, _errors.determineError)(err);
        throw error;
