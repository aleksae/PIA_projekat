...
class Webhooks {
  ...
  retrieveWebhooks() {
    ...
    return _asyncToGenerator(function* () {
      try {
        const response = yield (0, _http.get)(_nodeFetch.default, `${_this.config.host}/webhooks`, _this.config, _this.config.sk);
  ...
  registerWebhook(body) {
    ...
    return _asyncToGenerator(function* () {
      try {
        const response = yield (0, _http.post)(_nodeFetch.default, `${_this2.config.host}/webhooks`, _this2.config, _this2.config.sk, body);
        return yield response.json;
      } catch (err) {
        const error = yield (0, _errors.determineError)(err);
        throw error;
  ...
  retrieveWebhook(id) {
    ...
    return _asyncToGenerator(function* () {
      try {
        const response = yield (0, _http.get)(_nodeFetch.default, `${_this3.config.host}/webhooks/${id}`, _this3.config, _this3.config.sk);
        return yield response.json;
      } catch (err) {
        const error = yield (0, _errors.determineError)(err);
        throw error;
  ...
  updateWebhook(id, body) {
    ...
    return _asyncToGenerator(function* () {
      try {
        const response = yield (0, _http.put)(_nodeFetch.default, `${_this4.config.host}/webhooks/${id}`, _this4.config, _this4.config.sk, body);
        return yield response.json;
      } catch (err) {
        const error = yield (0, _errors.determineError)(err);
        throw error;
  ...
  partiallyUpdateWebhook(id, body) {
    ...
    return _asyncToGenerator(function* () {
      try {
        const response = yield (0, _http.patch)(_nodeFetch.default, `${_this5.config.host}/webhooks/${id}`, _this5.config, _this5.config.sk, body);
        return yield response.json;
      } catch (err) {
        const error = yield (0, _errors.determineError)(err);
        throw error;
  ...
  removeWebhook(id) {
    ...
    return _asyncToGenerator(function* () {
      try {
        const response = yield (0, _http._delete)(_nodeFetch.default, `${_this6.config.host}/webhooks/${id}`, _this6.config, _this6.config.sk);
        return yield response.json;
      } catch (err) {
        const error = yield (0, _errors.determineError)(err);
        throw error;
