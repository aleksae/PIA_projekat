...
class Instruments {
  ...
  create(body) {
    ...
    return _asyncToGenerator(function* () {
      ...
      try {
        const response = yield (0, _http.post)(_nodeFetch.default, `${_this.config.host}/instruments`, _this.config, _this.config.sk, body);
  ...
  get(id) {
    ...
    return _asyncToGenerator(function* () {
      try {
        const response = yield (0, _http.get)(_nodeFetch.default, `${_this2.config.host}/instruments/${id}`, _this2.config, _this2.config.sk);
        return yield response.json;
      } catch (err) {
        const error = yield (0, _errors.determineError)(err);
        throw error;
  ...
  update(id, body) {
    ...
    return _asyncToGenerator(function* () {
      try {
        const response = yield (0, _http.patch)(_nodeFetch.default, `${_this3.config.host}/instruments/${id}`, _this3.config, _this3.config.sk, body);
        return yield response.json;
      } catch (err) {
        const error = yield (0, _errors.determineError)(err);
        throw error;
  ...
  delete(id) {
    ...
    return _asyncToGenerator(function* () {
      try {
        const response = yield (0, _http._delete)(_nodeFetch.default, `${_this4.config.host}/instruments/${id}`, _this4.config, _this4.config.sk);
        return yield response.json;
      } catch (err) {
        const error = yield (0, _errors.determineError)(err);
        throw error;
  ...
  getBankAccountFieldFormatting(country, currency) {
    ...
    return _asyncToGenerator(function* () {
      try {
        const response = yield (0, _http.get)(_nodeFetch.default, `${_this5.config.host}/validation/bank-accounts/${country}/${currency}`, _this5.config, _this5.config.sk);
        return yield response.json;
      } catch (err) {
        const error = yield (0, _errors.determineError)(err);
        throw error;
