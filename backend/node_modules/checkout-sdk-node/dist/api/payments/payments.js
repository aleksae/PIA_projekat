...
class Payments {
  ...
  request(body, idempotencyKey) {
    ...
    return _asyncToGenerator(function* () {
      try {
        ...
        const response = yield (0, _http.post)(_nodeFetch.default, `${_this.config.host}/payments`, _this.config, _this.config.sk, body, idempotencyKey);
  ...
  getPaymentList(body) {
    ...
    return _asyncToGenerator(function* () {
      ...
      try {
        const response = yield (0, _http.get)(_nodeFetch.default, url, _this2.config, _this2.config.sk);
  ...
  get(id) {
    ...
    return _asyncToGenerator(function* () {
      try {
        const response = yield (0, _http.get)(_nodeFetch.default, `${_this3.config.host}/payments/${id}`, _this3.config, _this3.config.sk);
        return response.json;
      } catch (err) {
        throw yield (0, _errors.determineError)(err);
      }
  ...
  getActions(id) {
    ...
    return _asyncToGenerator(function* () {
      try {
        const response = yield (0, _http.get)(_nodeFetch.default, `${_this4.config.host}/payments/${id}/actions`, _this4.config, _this4.config.sk);
        return response.json;
      } catch (err) {
        throw yield (0, _errors.determineError)(err);
      }
  ...
  increment(id, body, idempotencyKey) {
    ...
    return _asyncToGenerator(function* () {
      try {
        const response = yield (0, _http.post)(_nodeFetch.default, `${_this5.config.host}/payments/${id}/authorizations`, _this5.config, _this5.config.sk, body, idempotencyKey);
  ...
  capture(paymentId, body, idempotencyKey) {
    ...
    return _asyncToGenerator(function* () {
      try {
        const response = yield (0, _http.post)(_nodeFetch.default, `${_this6.config.host}/payments/${paymentId}/captures`, _this6.config, _this6.config.sk, body, idempotencyKey);
        return response.json;
      } catch (err) {
        throw yield (0, _errors.determineError)(err);
      }
  ...
  refund(paymentId, body, idempotencyKey) {
    ...
    return _asyncToGenerator(function* () {
      try {
        const response = yield (0, _http.post)(_nodeFetch.default, `${_this7.config.host}/payments/${paymentId}/refunds`, _this7.config, _this7.config.sk, body, idempotencyKey);
        return response.json;
      } catch (err) {
        throw yield (0, _errors.determineError)(err);
      }
  ...
  void(paymentId, body, idempotencyKey) {
    ...
    return _asyncToGenerator(function* () {
      try {
        const response = yield (0, _http.post)(_nodeFetch.default, `${_this8.config.host}/payments/${paymentId}/voids`, _this8.config, _this8.config.sk, body, idempotencyKey);
        return response.json;
      } catch (err) {
        throw yield (0, _errors.determineError)(err);
      }
