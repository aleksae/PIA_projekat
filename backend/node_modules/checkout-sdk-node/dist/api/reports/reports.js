...
class Reports {
  ...
  getReportDetails(id) {
    ...
    return _asyncToGenerator(function* () {
      try {
        const response = yield (0, _http.get)(_nodeFetch.default, `${_this2.config.host}/reports/${id}`, _this2.config, _this2.config.sk);
        return yield response.json;
      } catch (err) {
        const error = yield (0, _errors.determineError)(err);
        throw error;
  ...
  getReportFile(id, fileId) {
    ...
    return _asyncToGenerator(function* () {
      try {
        const response = yield (0, _http.get)(_nodeFetch.default, `${_this3.config.host}/reports/${id}/files/${fileId}`, _objectSpread(_objectSpread({}, _this3.config), {}, {
          csv: true
        }), _this3.config.sk);
