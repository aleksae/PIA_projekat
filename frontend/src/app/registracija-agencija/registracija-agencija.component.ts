      ...
      if(this.uploadedFiles.length!=0){
        ...
        await this.http.post('http://localhost:4000/fajlovi/otpremanje', formData)
            .subscribe((response : responseExtended) => {
                ...
                this.korisnikService.registracija(this.k_ime, sha512.sha512(this.lozinka), this.telefon, this.mejl, this.filename_server, dodatno, "agencija", this.admin).subscribe(async respObj=>{
