...
let RegistracijaKlijenataComponent = class RegistracijaKlijenataComponent {
    fileChange(element) {
        ...
        if (this.uploadedFiles) {
            if (this.uploadedFiles.length != 0) {
                ...
                await this.http.post('http://localhost:4000/fajlovi/otpremanje', formData)
                    ...
                    this.korisnikService.registracija(this.k_ime, sha512.sha512(this.lozinka), this.telefon, this.mejl, this.filename_server, dodatno, "klijent").subscribe(async (respObj) => {
...
RegistracijaKlijenataComponent = __decorate([
    Component({
...
export { RegistracijaKlijenataComponent };
//# sourceMappingURL=registracija-klijenata.component.js.map