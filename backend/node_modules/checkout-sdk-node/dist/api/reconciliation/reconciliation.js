...
class Reconciliation {
  ...
  getPayments(body) {
    ...
    return _asyncToGenerator(function* () {
      try {
        ...
        const response = yield (0, _http.get)(_nodeFetch.default, url, _this.config, _this.config.sk);
  ...
  getPayment(paymentId) {
    ...
    return _asyncToGenerator(function* () {
      try {
        const response = yield (0, _http.get)(_nodeFetch.default, `${_this2.config.host}/reporting/payments/${paymentId}`, _this2.config, _this2.config.sk);
  ...
  getPaymentsCsv(body) {
    ...
    return _asyncToGenerator(function* () {
      try {
        ...
        const response = yield (0, _http.get)(_nodeFetch.default, url, _objectSpread(_objectSpread({}, _this3.config), {}, {
          csv: true
        }), _this3.config.sk);
  ...
  getStatements(body) {
    ...
    return _asyncToGenerator(function* () {
      try {
        ...
        const response = yield (0, _http.get)(_nodeFetch.default, url, _this4.config, _this4.config.sk);
        return yield response.json;
      } catch (err) {
        const error = yield (0, _errors.determineError)(err);
        throw error;
  ...
  getStatementCsv(statementId) {
    ...
    return _asyncToGenerator(function* () {
      try {
        const response = yield (0, _http.get)(_nodeFetch.default, `${_this5.config.host}/reporting/statements/${statementId}/payments/download`, _objectSpread(_objectSpread({}, _this5.config), {}, {
          csv: true
        }), _this5.config.sk);
        return yield response.csv;
      } catch (err) {
  ...
  getPaymentsActions(body) {
    ...
    return _asyncToGenerator(function* () {
      try {
        ...
        const response = yield (0, _http.get)(_nodeFetch.default, url, _this6.config, _this6.config.sk);
        return yield response.json;
      } catch (err) {
        const error = yield (0, _errors.determineError)(err);
        throw error;
  ...
  getPaymentsAction(actionsId) {
    ...
    return _asyncToGenerator(function* () {
      try {
        const response = yield (0, _http.get)(_nodeFetch.default, `${_this7.config.host}/reporting/payments/actions/${actionsId}`, _this7.config, _this7.config.sk);
        return yield response.json;
      } catch (err) {
        const error = yield (0, _errors.determineError)(err);
        throw error;
  ...
  getPaymentsActionsCsv(body) {
    ...
    return _asyncToGenerator(function* () {
      try {
        ...
        const response = yield (0, _http.get)(_nodeFetch.default, url, _objectSpread(_objectSpread({}, _this8.config), {}, {
          csv: true
        }), _this8.config.sk);
        return yield response.csv;
      } catch (err) {
  ...
  getAction(actionId) {
    ...
    return _asyncToGenerator(function* () {
      try {
        const response = yield (0, _http.get)(_nodeFetch.default, `${_this9.config.host}/reporting/actions/${actionId}`, _this9.config, _this9.config.sk);
        return yield response.json;
      } catch (err) {
        const error = yield (0, _errors.determineError)(err);
        throw error;
