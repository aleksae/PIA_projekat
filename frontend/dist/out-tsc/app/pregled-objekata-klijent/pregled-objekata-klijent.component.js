...
let PregledObjekataKlijentComponent = class PregledObjekataKlijentComponent {
    constructor(objekatService, cdRef, broadcastService) {
    ...
    ngOnInit() {
        ...
        this.objekatService.sve_za_korisnika(this.ulogovan.korisnicko_ime).subscribe((objekti) => {
            this.objekti = objekti;
            this.broadcastService.porukaOStatusu.subscribe((msg) => {
                if (msg['status'] == 1) {
...
], PregledObjekataKlijentComponent.prototype, "canvasi", void 0);
__decorate([
    HostListener('window:resize', ['$event'])
], PregledObjekataKlijentComponent.prototype, "onResize", null);
PregledObjekataKlijentComponent = __decorate([
    Component({
...
export { PregledObjekataKlijentComponent };
//# sourceMappingURL=pregled-objekata-klijent.component.js.map