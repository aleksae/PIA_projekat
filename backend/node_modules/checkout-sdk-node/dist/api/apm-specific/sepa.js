...
class Sepa {
  ...
  cancelMandate(id) {
    ...
    return _asyncToGenerator(function* () {
      ...
      try {
        const response = yield (0, _http.post)(_nodeFetch.default, url, _this2.config, _this2.config.sk);
        return yield response.json;
      } catch (err) {
        const error = yield (0, _errors.determineError)(err);
        throw error;
  ...
  getPPROMandate(id) {
    ...
    return _asyncToGenerator(function* () {
      ...
      try {
        const response = yield (0, _http.get)(_nodeFetch.default, url, _this3.config, _this3.config.sk);
        return yield response.json;
      } catch (err) {
        const error = yield (0, _errors.determineError)(err);
        throw error;
  ...
  cancelPPROMandate(id) {
    ...
    return _asyncToGenerator(function* () {
      ...
      try {
        const response = yield (0, _http.post)(_nodeFetch.default, url, _this4.config, _this4.config.sk);
        return yield response.json;
      } catch (err) {
        const error = yield (0, _errors.determineError)(err);
        throw error;
