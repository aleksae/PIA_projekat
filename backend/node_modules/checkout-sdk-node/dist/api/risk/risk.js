...
class Risk {
  ...
  requestPreAuthentication(body) {
    ...
    return _asyncToGenerator(function* () {
      try {
        const response = yield (0, _http.post)(_nodeFetch.default, `${_this.config.host}/risk/assessments/pre-authentication`, _this.config, _this.config.sk, body);
  ...
  requestPreCapture(body) {
    ...
    return _asyncToGenerator(function* () {
      try {
        const response = yield (0, _http.post)(_nodeFetch.default, `${_this2.config.host}/risk/assessments/pre-capture`, _this2.config, _this2.config.sk, body);
        return yield response.json;
      } catch (err) {
        const error = yield (0, _errors.determineError)(err);
        throw error;
