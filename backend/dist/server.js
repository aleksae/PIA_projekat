...
const fajlovi_router_1 = __importDefault(require("./routers/fajlovi.router"));
const privremeni_link_1 = __importDefault(require("./models/privremeni_link"));
const objekat_router_1 = __importDefault(require("./routers/objekat.router"));
const posao_router_1 = __importDefault(require("./routers/posao.router"));
const radnik_router_1 = __importDefault(require("./routers/radnik.router"));
...
router.use('/fajlovi', fajlovi_router_1.default);
router.use('/objekti', objekat_router_1.default);
router.use('/poslovi', posao_router_1.default);
router.use('/radnici', radnik_router_1.default);
app.use('/', router);
...
app.post('/posalji_mejl', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { v4: uuidv4 } = require('uuid');
    let token = uuidv4();
    var mailOptions = {
        from: '"Реновирајмо заједно" <no-reply@renovirajmo-zajedno.com>',
        to: req.body.mejl,
    ...
    <h1 style="margin: 0; color: #555555; font-size: 23px; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; line-height: 120%; text-align: center; direction: ltr; font-weight: 700; letter-spacing: normal; margin-top: 0; margin-bottom: 0;"><span class="tinyMce-placeholder">РЕНОВИРАЈМО ЗАЈЕДНО</span></h1>
    </td>
    </tr>
    </table>
    </td>
    ...
    <h1 style="margin: 0; color: #101010; direction: ltr; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; font-size: 27px; font-weight: normal; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0;"><strong>Заборављена лозинка</strong></h1>
    </td>
    </tr>
    </table>
    </td>
    ...
    <p style="margin: 0; font-size: 12px; text-align: center; mso-line-height-alt: 21.6px;">Уколико сте заборавили лозинку, можете је променити на линку испод у наредних 10 минута. Ако не, игноришите овај мејл.</p>
    </div>
    </div>
    </td>
    </tr>
    ...
    now = new Date(now);
    let pl = new privremeni_link_1.default({
        mejl: req.body.mejl,
        token: token,
        rok_vazenja: now
    });
...
app.get('/dohvati_tokene', (req, resp) => {
    privremeni_link_1.default.find({}, (err, linkovi) => {
        if (err) {
            console.log(err);
